...
class TestFastAPIEndpoints(unittest.TestCase):
    ...
    def test_1_create_users(self):
        ...
        for user in user_data:
            response = requests.post(f"{self.BASE_URL}/users/users/", json=user, params={"no_cache": True})
            logging.info(
    ...
    def test_4_read_user(self):
        ...
        response = requests.get(url, params={"no_cache": True})
        logging.info(
    ...
    def test_5_search_users(self):
        ...
        response = requests.post(url, json=data, params={"no_cache": True})
        logging.info(
